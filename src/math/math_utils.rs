...
pub fn float_lt_precision(a: f64, b: f64, _precision: u8) -> bool {
    //let diff = (a - b).abs();
    a < b //|| diff < 10_f64.powi(-(precision as i32))
}
pub fn float_gt_precision(a: f64, b: f64, _precision: u8) -> bool {
    //let diff = (a - b).abs();
    a > b //|| diff < 10_f64.powi(-(precision as i32))
}

pub fn float_le_precision(a: f64, b: f64, _precision: u8) -> bool {
    a <= b
}

pub fn float_ge_precision(a: f64, b: f64, _precision: u8) -> bool {
    a >= b
}
