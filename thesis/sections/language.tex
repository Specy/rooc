...
nome \texttt{x\_A} anche fuori da un'iterazione, così i modelli prodotti dal
compilatore restano a loro volta sorgenti valide. La forma \emph{escaped}
\texttt{\textbackslash x\_y} permette di trattare letteralmente un nome
contenente l'underscore, disattivando l'espansione automatica.
