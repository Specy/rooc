...
del \emph{solver} vero e proprio: strumenti come \textbf{Gurobi}~\cite{gurobi} o
\textbf{HiGHS}~\cite{highs2018} sono motori di risoluzione, non linguaggi di
modellazione, e ROOC vi si appoggia come back-end intercambiabili
