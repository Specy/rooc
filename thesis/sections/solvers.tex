...
peraltro una diffusione che va oltre questo progetto: è pubblicato su
\emph{crates.io},\footnote{\url{https://crates.io/crates/microlp}} dove ha superato
il milione di download, ed è utilizzato da \texttt{good\_lp}, tra le più note
librerie di programmazione lineare per Rust.
