...
prestazioni. Il simplesso implementato nel progetto privilegia la trasparenza, a
scapito delle prestazioni e con il limite delle sole variabili continue;
\texttt{microlp} è il più generale e copre l'intera gamma dei modelli di ROOC;
\texttt{copper} e Clarabel sono invece specializzati, rispettivamente, per i
problemi binari e per quelli puramente continui. Grazie all'architettura a pipe,
la scelta del solver, manuale o automatica, non richiede modifiche al resto
della pipeline.
